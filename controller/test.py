# test.py
# Used for conducting predefined tests
...
# Normalize gender to 1 letter F or M (For Male or Other)
...
outfile = open(RESULT_DIRECTORY + '{0}-{1}-{2}-{3}.csv'
                .format(test_type, age, gender, test_time), "w")
